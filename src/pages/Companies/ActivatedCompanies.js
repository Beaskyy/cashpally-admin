    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `${baseURL}/api/admin/company/activated`,
          options
        )
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Activated Auto Partners | Cashpally Admin</title>
        </MetaTags>
        <div className="container-fluid">
          <Breadcrumbs
            maintitle="Cashpally"
            title="Auto Partners"
            breadcrumbItem="Activated Auto Partners"
          />
          ...
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <CardTitle className="h4">Activated Auto Partners</CardTitle>
                  {loading ? (
