...
const WebRepayments = () => {
  ...
  const getWebRepayments = async () => {
    ...
    const response = await fetch(`${baseURL}/api/admin/loan/web-repayment`, options)
    ...
    <React.Fragment>
      <div className="page-content">
        ...
        <div className="container-fluid">
          <Breadcrumbs maintitle="Cashpally" title="Repayments" breadcrumbItem="Web Repayments" />
          
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <CardTitle className="h4">Web Repayments</CardTitle>
                  {
                    loading ? (
