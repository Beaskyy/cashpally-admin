...
const DebitTransactions = () => {
  ...
  const getDebitTransactions = async () => {
    ...
    const response = await fetch(`${baseURL}/api/admin/transaction/debit`, options)
    ...
    <React.Fragment>
      <div className="page-content">
        ...
        <div className="container-fluid">
          <Breadcrumbs maintitle="Cashpally" title="Transactions" breadcrumbItem="Debit Transactions" />
          
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <CardTitle className="h4">Debit Transactions</CardTitle>
                  {
                    loading ? (
