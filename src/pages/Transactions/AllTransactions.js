...
const AllTransactions = () => {
  ...
  const getAllTransactions = async () => {
    ...
    const response = await fetch(`${baseURL}/api/admin/transaction/all`, options)
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>All Transactions | Cashpally Admin</title>
        </MetaTags>
        <div className="container-fluid">
          <Breadcrumbs maintitle="Cashpally" title="Transactions" breadcrumbItem="All Transactions" />
          
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                  <CardTitle className="h4">All Transactions</CardTitle>
                  {
                    loading ? (
