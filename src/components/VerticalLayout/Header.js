...
import logosmImg from "../../assets/images/cashpally-logo-sm.png";
import logolightImg from "../../assets/images/cashpally-logo.png";
          ...
          <div className="d-flex">
            <div className="navbar-brand-box">
              ...
              <Link to="/" className="logo logo-light">
                <span className="logo-sm">
                  <img src={logosmImg} alt="" height="25" />
                </span>
                <span className="logo-lg">
                  <img src={logolightImg} alt="" height="38" />
                </span>
              </Link>
            </div>
